...
import glob
from PCR_CG.lib.benchmark_utils import to_o3d_pcd, to_tsfm, get_correspondences
from PCR_CG.datasets.visualize import make_open3d_point_cloud, draw_registration_result
from PIL import Image, ImageFilter
from torchvision.transforms import transforms
from PCR_CG.projection import Projection
from PCR_CG.datasets.visualize import viz_supernode, save_ply, draw_registration_result, unproject, adjust_intrinsic
...
class IndoorDataset(Dataset):
    ...
    def __init__(self, infos, config, data_augmentation=True):
        ...
        self.image_size = [480, 640]  # [480,640] FIX
        self.depth_img_size = [480, 640]  # [480,640] FIX
    ...
    def __getitem__(self, item):
        ...
        if self.image_feature:
            if self.img_num == 1:
                ...
                data['origin_intrinsics'] = intrinsics
                ...
                data['src_init_pcd'] = src_init_pcd
                data['src1_world2camera'] = src1_world2camera
                # camera2world = np.eye(4)
                # camera2world[:3,:3] = rot_ab
                # camera2world = torch.from_numpy(camera2world).float()
                # data['camera2world'] = camera2world
                ...
                data['src_path'] = src_color_path1
                data['tgt_path'] = tgt_color_path1
                data['src_pose'] = src_pose1
                data['tgt_pose'] = tgt_pose1
                data['src_depth_image'] = src_depth_image1
                data['src_depth_path'] = src_depth_path1
                data['tgt_depth_image'] = tgt_depth_image1
                data['tgt_depth_path'] = tgt_depth_path1
                print(id_name)
            elif self.img_num == 2:
